...
class EditorPanel(private val hudDesigner: GuiHudDesigner, var x: Int, var y: Int) : MinecraftInstance() {
    ...
    fun drawPanel(mouseX: Int, mouseY: Int, wheel: Int) {
        ...
        // Draw panel
        drawRectInt(x, y + 12, x + width, y + realHeight, Color(0, 0, 0, 150).rgb)
        when {
        ...
        // Scrolling end
        if (shouldScroll) {
            drawRectInt(x + width - 5, y + 15, x + width - 2, y + 197,
                    Color(41, 41, 41).rgb)
    ...
    private fun drawCreate(mouseX: Int, mouseY: Int) {
        ...
        drawRectInt(x, y, x + width, y + 12, guiColor)
    ...
    private fun drawSelection(mouseX: Int, mouseY: Int) {
        ...
        if (showConfirmation) {
            ...
            drawRectInt(dialogX, dialogY + 10, dialogX + dialogWidth, dialogY + dialogHeight + 10, Color(0, 0, 0, 150).rgb)
            ...
            // Yes button
            drawRectInt(yesButtonX, buttonY, yesButtonX + buttonWidth, buttonY + buttonHeight, Color.GREEN.rgb)
            Fonts.font35.drawString("Yes", yesButtonX + 8f, buttonY.toFloat() + 5, Color.WHITE.rgb)

            // No button
            drawRectInt(noButtonX, buttonY, noButtonX + buttonWidth, buttonY + buttonHeight, Color.RED.rgb)
