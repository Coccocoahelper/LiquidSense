...
import net.ccbluex.liquidbounce.utils.render.RenderUtils.drawRectInt
...
object SlowlyStyle : Style() {
    ...
    override fun drawButtonElement(mouseX: Int, mouseY: Int, buttonElement: ButtonElement) {
        drawRectInt(buttonElement.x - 1, buttonElement.y - 1, buttonElement.x + buttonElement.width + 1, buttonElement.y + buttonElement.height + 1,
            getHoverColor(
    ...
    override fun drawModuleElementAndClick(mouseX: Int, mouseY: Int, moduleElement: ModuleElement, mouseButton: Int?): Boolean {
        drawRectInt(moduleElement.x - 1, moduleElement.y - 1, moduleElement.x + moduleElement.width + 1, moduleElement.y + moduleElement.height + 1,
        ...
        if (moduleValues.isNotEmpty()) {
            ...
            if (moduleElement.showSettings) {
                ...
                if (moduleElement.settingsWidth > 0 && moduleElement.settingsHeight > 0)
                    drawBorderedRect(minX, yPos, maxX, yPos + moduleElement.settingsHeight, 3, Color(42, 57, 79).rgb, Color(54, 71, 96).rgb)
                ...
                for (value in moduleValues) {
                    ...
                    when (value) {
                        ...
                        is FloatValue -> {
                            ...
                            drawRectInt(x, y, x + width, y + 2, Int.MAX_VALUE)
                            drawRectInt(x, y, sliderValue, y + 2, color.rgb)
