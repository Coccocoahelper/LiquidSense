...
object LiquidBounceStyle : Style() {
    override fun drawPanel(mouseX: Int, mouseY: Int, panel: Panel) {
        ...
        if (panel.scrollbar && panel.fade > 0) {
            drawRectInt(panel.x - 2, panel.y + 21, panel.x, panel.y + 16 + panel.fade, Color.DARK_GRAY.rgb)
            ...
            drawRectInt(panel.x - 2, minY.roundToInt(), panel.x, maxY.roundToInt(), Color.GRAY.rgb)
        }
    }
                ...
                for (value in moduleValues) {
                    ...
                    when (value) {
                        is BoolValue -> {
                            ...
                            drawRectInt(minX, yPos + 2, maxX, yPos + 14, Int.MIN_VALUE)
                        ...
                        is FloatValue -> {
                            ...
                            drawRectInt(minX, yPos + 2, maxX, yPos + 24, Int.MIN_VALUE)
                            drawRectInt(minX + 4, yPos + 18, maxX - 4, yPos + 19, Int.MAX_VALUE)
                            ...
                            drawRectInt(8 + sliderValue, yPos + 15, sliderValue + 11, yPos + 21, guiColor)
